...
public class ManufacturingDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Product>(productEntityConfiguration =>
        {
            ...
            productEntityConfiguration.Property(product => product.CreatedDateTimeUtc).HasDefaultValueSql("datetime('now')");
        });
        ...
        modelBuilder.Entity<Project>(projectEntityConfiguration =>
        {
            ...
            projectEntityConfiguration.Property(project => project.CreatedDateTimeUtc).HasDefaultValueSql("datetime('now')");
        });

        modelBuilder.Entity<WorkOrder>(workOrderEntityConfiguration =>
        {
            workOrderEntityConfiguration.ToTable("WorkOrder");
            ...
            workOrderEntityConfiguration.Property(workOrder => workOrder.CreatedDateTimeUtc).HasDefaultValueSql("datetime('now')");
        ...
        {
            workOrderLineEntityConfiguration.ToTable("WorkOrderLine");
            ...
            workOrderLineEntityConfiguration.Property(workOrderLine => workOrderLine.CreatedDateTimeUtc).HasDefaultValueSql("datetime('now')");
        });
    }
}