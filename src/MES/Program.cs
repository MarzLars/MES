...
[
    new OrderLineRequest(1, 10), // 10 × HEA 200 beam
    new OrderLineRequest(2, 5) // 5  × S355 plate
]);
...
foreach (var line in workOrder.Lines)
    Console.WriteLine(
        $"{line.ProductName,-20} {line.Quantity,5}  {line.WeightKgPerUnit,10:F2}  {line.TotalWeightKg,10:F2}");
Console.WriteLine(new string('-', 52));
